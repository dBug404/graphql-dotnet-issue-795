...
{
    /// <summary>
    /// Klasse zur Definition eines PerRequestModules für StructureMap
    /// </summary>
    public class StructureMapContainerPerRequestModule : IHttpModule
    {
        ...
        {
            get { return new HttpContextWrapper(HttpContext.Current).GetContainer(); }
            set { new HttpContextWrapper(HttpContext.Current).SetContainer(value); }
        }
